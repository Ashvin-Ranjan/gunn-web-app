window.langs.hi = {
    html: {
      ...
      'ash-creds': '{name|अष} for a language.',
      ...
      heaucques: 'OK.',
      'henry-creds': '{name|हेनरी} made the Google Maps overlay.',
      ...
      'kevin-creds': '{name|केविन} for the French translation.',
      ...
      'matthew-creds': '{name|माथिऊ} for the virtual bell.',
      ...
      options: 'Options',
      'other-apps':
        'Gunn apps made by other people: {tga-ios|TheGunnApp} by the iOS App Development club · {tga-android|TheGunnApp} by David C. · {bellhop|Bellhop} by Kartik C. · {nugwa|Not UGWA} by Tomer S. · {hw-central|Homework Central} by Saumya S. · {ugwa-backend|UGWA Backend} by केविन Y.',
      'other-versions':
      ...
      schedule: 'Schedule',
      'sean-creds': '{name|षाऊन} made most of the app.',
      ...
      staff: 'Staff',
      'staff-disclaimer':
        "Please note that staff information was taken from the administration's {link|staff directory as of January 29th, 2021}, so attribute inaccuracies to them.",
      'staff-list': 'Staff list',
      'staff-name': 'Staff name',
      support: 'Student resources',
      theme: 'Theme',
      'this-is-joke': '(ये जोक है)',
    ...
    other: {
      ...
      'barcode-student-placeholder': 'ये आई डी किस का है',
